...
Meu nome é Lucas Briahn e sou um entusiasta do desenvolvimento de software, apaixonado pelo desenvolvimento web. Atualmente, estou cursando Engenharia de Software na Universidade Estácio de Sá. Com mais de quatro anos de imersão na área, tive a oportunidade de participar de diversos projetos e adquirir conhecimento em diversas tecnologias modernas.
...
- Engenharia de Software (em andamento) – Universidade Estácio de Sá – EAD  
- Técnico em Informática para Internet – Concluído

## 🚀 **Experiência**

**Professor de Ensino Técnico em Desenvolvimento de Sistemas**  
